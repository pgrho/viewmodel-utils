    ...
    where T : class
{
    ...
    [Parameter]
    public IDictionary<string, object> HeaderBackgroundAttributes { get; set; }
    ...
    [Parameter]
    public IDictionary<string, object> ScrollerAttributes { get; set; }
    ...
    [Parameter]
    public IDictionary<string, object> TableHeadAttributes { get; set; }
    ...
    [Parameter]
    public IDictionary<string, object> TableBodyAttributes { get; set; }
